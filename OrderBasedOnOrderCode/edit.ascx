            ...
            $("#lnkSave" + uniqueId).bind("click", function () {
                ...
                if (validSave) {
                    ...
                    if ($("#txtTitle" + uniqueId).val() == '')
                        $("#txtTitle" + uniqueId).val("Order Based On Order Code");
        ...
        function LoadCurrentSettings(uniqueId, FBUserId, UserWidgetId, numberFieldType) {
            ...
            FBAPI.FindExtendedProperty("CustomWidgetData_" + FBUserId + "_" + UserWidgetId,
                    function (msg) {
                        ...
                        var getProjectsURL = $.url("Widgets/OrderBasedOnOrderCode/GetData.ashx?Method=GetProjects");
                        ...
                        if (msg != null && msg.length > 0) {
                            ...
                            if (data.Title == undefined || data.Title == '') data.Title = "Order Based On Order Code"; //default
                            ...
                            $title.val("Order Based On Order Code");
